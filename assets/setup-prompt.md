...
3. Install the entire directory as the personal skill at `%USERPROFILE%\.codex\skills\codex-model-routing`. Do not install only `SKILL.md`; its references, assets, UI metadata, and installer are part of the package.
